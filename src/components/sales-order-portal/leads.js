                  ...
                  <TableBody>
                    {leadRowTableData.map((row) => (
                      ...
                      >
                        ...
                        >
                          <a className={classes.leadIdTable}> {row.leadId}</a>
                        </TableCell>
      ...
      {isNewClicked && (
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            ...
            >
              <InputLabel id="demo-multiple-name-label">Lead Owner</InputLabel>
              <Select
                labelId="demo-multiple-name-label"
                id="demo-multiple-name"
          ...
          <Grid item xs={6}>
            ...
            >
              <InputLabel id="demo-multiple-name-label">Call Status</InputLabel>
              <Select
                labelId="demo-multiple-name-label"
                id="demo-multiple-name"
          ...
          <Grid item xs={6} className="sales-order-form-data">
            <div className="row">
              <div className="col-6 label-alignment">
                {" "}
                <label>
                  Do you currently have <br /> brightspeed internet service ? *:
                </label>
              </div>
              <div className="col-6">
                {" "}
